...
function renderRainTip(w) {
  ...
  if (tip) {
    mountHTML('rainTipMount', '<section class="rain-tip-card card" id="rainTipCard"><img class="rain-tip-ico" src="assets:///assets/web/icons/rain.png" alt=""><span class="rain-tip-body"><span class="rain-tip-text">' + escapeHTML(tip) + '</span><span class="rain-tip-action" id="rainTipAction">' + (rainTrendOpen ? '收起降雨趋势 ›' : '查看降雨趋势 ›') + '</span></span></section>');
